//Leave as it is (with macOS code for easy update in feaure)
#define __MOBILE__
...
#endif
{
    public static class FontExtensionsOverrided
    {
        ...
        public static UIFont ToUIFontForAny(string family, float size, FontAttributes attributes)
        {
            return ToUIFont(family, size, attributes);
        }
